        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-10">
          ...
          {showDebugInfo && (
            <div className="mt-2 p-2 sm:p-3 bg-gray-100 rounded-lg text-xs text-left max-w-full overflow-x-auto">
              <p className="font-semibold text-gray-700 mb-1">🔐 Puedes usar:</p>
              <ul className="space-y-1 text-gray-600">
                <li className="truncate">• Email o nombre de usuario</li>
                <li className="truncate">• El primer usuario que registres</li>
              </ul>
            </div>
          )}
        </div>

        {/* Tarjeta de login - responsive */}
